/**
 * Custom implementation of LocalServerReciever by Google.
 * 
 * Google's implementation does not work within Phantombot's
...
public final class CustomLocalServerReceiver implements VerificationCodeReceiver {
     ...
     * @param port Port to use or {@code -1} to select an unused port
     */
    CustomLocalServerReceiver(String host, int port, String callbackPath, String successLandingPageUrl,
    ...
    public static final class Builder {
        ...
        public CustomLocalServerReceiver build() {
            return new CustomLocalServerReceiver(host, port, callbackPath, successLandingPageUrl,
