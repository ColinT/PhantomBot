...
public class TwitchPubSubChannelPoints {
    private static final Map<String, TwitchPubSubChannelPoints> instances = Maps.newHashMap();
     ...
     */
    public static TwitchPubSubChannelPoints instance(String channel, int channelId, int botId, String oAuth) {
        TwitchPubSubChannelPoints instance = instances.get(channel);

        if (instance == null) {
            instance = new TwitchPubSubChannelPoints(channel, channelId, botId, oAuth);
    ...
    private static TwitchPubSubChannelPoints instance(String channel) {
        TwitchPubSubChannelPoints instance = instances.get(channel);
     ...
     * @param {string}  oauth      The bots tmi oauth token.
     */
    private TwitchPubSubChannelPoints(String channel, int channelId, int botId, String oAuth) {
    ...
    public void reconnect() {
        ...
        try {
            new Thread( () -> {
                TwitchPubSubChannelPoints.instance(channel).doReconnect();
            }).start();
        } finally {
            lock.unlock();
        }
    ...
    private class TwitchPubSubWS extends WebSocketClient {
        private final TwitchPubSubChannelPoints twitchPubSub;
         ...
         * @param {string}  oauth      The bots tmi oauth token.
         */
        private TwitchPubSubWS(URI uri, TwitchPubSubChannelPoints twitchPubSub, int channelId, int botId, String oAuth) {
        ...
        public void onOpen(ServerHandshake handshakedata) {
            ...
            String[] type = new String[] {"channel-points-channel-v1." + channelId};
        ...
        public void onClose(int code, String reason, boolean remote) {
            ...
            com.gmt2001.Console.out.println("Lost connection to Twitch Channel Points Data Feed, retrying in 10 seconds");
