...
$(function() {
    ...
    window.onYouTubeIframeAPIReady = () => {
        ...
        player.dbQuery('get_module_status', 'modules', (data) => {
            if (data['./systems/youtubePlayer.js'] === 'false' && data['./custom/youtubePlayer.js'] === 'false') {
        ...
        player.addListener('play', (e) => {
            ...
            if (player.firstLoad === true) {
                ...
                player.API.setVolume($('#volume-slider').slider('option', 'value')); // Reset the volume when a new song starts playing
